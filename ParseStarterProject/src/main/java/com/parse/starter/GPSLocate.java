...
/*                gps = new GPSTracker(GPSLocate.this);
                if (gps.canGetLocation()) {
                    ...
                    */
                if (!(type == "Type of Complaint" || chooseLocation == "Choose Location") && address != null) {
                    ...
                    query.whereWithinKilometers("location", geoPoint, 50);
                                ...
                                if (e == null) {
                                    if (objects.size() != 0) {
                                        for (ParseObject object : objects) {
                                            if (type == String.valueOf(object.get("typeofcomplaint"))) {
